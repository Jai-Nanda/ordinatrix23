...
export default function pricing() {
    return (
        ...
        <link rel="icon" href="/favicon.svg" />
            ...
            <section class="">
                <div class="container max-w-7xl m-auto py-12 px-6">
                    <h1 class="text-5xl text-primary-color tracking-wider font-bold text-center my-10">
                        PRICING
                    </h1>
                    <p class="text-center text-lg text-gray-700 mt-2 px-6">
                        Flexible packages to suit your use-case.
                    </p>
                    <div class="h-1 mx-auto bg-primary-color w-24 opacity-75 mt-4 rounded"></div>

                    <div class="mt-10">
                        <div class="  flex justify-between  ">
                            <div class="border-2 border-primary-color rounded-2xl h-80 w-80">
                                <div class="flex  flex-col justify-between ">
                                    <div class="flex justify-start flex-col items-start pl-12">
                                        <h1 class="text-sm  font-semibold uppercase p-3 pb-0 text-center tracking-wide text-primary-color">
                                            LITE
                                        </h1>
                                    ...
                                    <div class="flex flex-wrap mt-3 px-6">
                                        <ul>
                                            <li class="flex items-center">
                                                ...
                                                <span class="text-gray-700 text-lg ml-3">Paid deliveries for orders under
                                                    $30</span
                                                >
                                            </li>
                                            <li class="flex items-center">
                            ...
                            <div class="border-2 border-primary-color rounded-2xl h-[450px] w-80">
                                <div class="flex  flex-col justify-between ">
                                    <div class="flex justify-start flex-col items-start pl-12">
                                        <h1 class="text-sm  font-semibold uppercase p-3 pb-0 text-center tracking-wide text-primary-color">
                                            PLUS
                                    ...
                                    <div class="flex flex-wrap mt-3 px-6">
                                        <ul>
                                            <li class="flex items-center">
                                                ...
                                                <span class="text-gray-700 text-lg ml-3">Big discounts everyday</span
                                                >
                                            </li>
                                            <li class="flex items-center">
                                                <div
